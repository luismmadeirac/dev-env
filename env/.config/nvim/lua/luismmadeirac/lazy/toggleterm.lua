...
return {
  ...
  keys = {
    ...
    { "<leader>tt", "<cmd>ToggleTerm direction=float size=20<cr>", mode = {"n", "t"}, desc = "ToggleTerm (Float 40%)" },

    -- Horizontal terminal: size is number of rows (e.g., 15)
    { "<leader>th", "<cmd>ToggleTerm direction=horizontal size=20<cr>", mode = {"n", "t"}, desc = "ToggleTerm (Horizontal 15 lines)" },

    -- Vertical terminal: size is number of columns (e.g., 80)
    { "<leader>tv", "<cmd>ToggleTerm direction=vertical size=30<cr>", mode = {"n", "t"}, desc = "ToggleTerm (Vertical 80 cols)" },
